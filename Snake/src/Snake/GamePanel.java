...
public class GamePanel extends JPanel implements ActionListener {
	 ...
	 * ActionListener() {
	 * 
	 * @Override public void actionPerformed(ActionEvent e) { if (!running) {
	 * startGame(); } } });
	 * 
	 ...
	 * pauseGame(); } } });
	 * 
	 * this.add(startButton); this.add(pauseButton);
	 * 
	 * this.add(startButton); this.add(pauseButton); }
	 */
	...
	public class MyKeyAdapter extends KeyAdapter {
		...
		public void keyPressed(KeyEvent e) {
			...
			case KeyEvent.VK_LEFT:
				if (direction != 'R') {
					direction = 'L'; // Update direction to left
				}
				break;
			case KeyEvent.VK_RIGHT:
				if (direction != 'L') {
					direction = 'R'; // Update direction to left
				}
				break;
			case KeyEvent.VK_UP:
				if (direction != 'D') {
					direction = 'U'; // Update direction to left
				}
				break;
			case KeyEvent.VK_DOWN:
				if (direction != 'U') {
					direction = 'D'; // Update direction to left
				}
				break;
